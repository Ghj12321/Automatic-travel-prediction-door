...
void INT_ISR_T()
{
   ...
   else if((count >=61) && (count <= 121))
   {
   led3 = 0; led4 = 1; led5 = 0;
   }
   else if((count >=122) && (count <= 182))
   {
   led3 = 0; led4 = 0; led5 = 1;
   }
   else if((count >=183) && (count <= 243))
   {
   led3 = 1; led4 = 1; led5 = 0;
   }
   else if((count >=243) && (count <= 303)) {led3 = 0; led4 = 1; led5 = 1;}
   else if(count >=304) {count = 0;}
...
void flagup()
{
         ...
         /*safe_sensor_count++;
         if(safe_sensor_count % 2 == 0)
        {
         led2 = 0;
        }
        else if(safe_sensor_count % 2 == 1)
        {led2 = 1;}
       */
